...
Local GitHub-style UI to review commits on a branch one at a time and leave comments on a commit, a file, or a diff line. Comments are stored as JSON under `.review/` in the target repository.
